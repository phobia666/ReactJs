...
const RightCardContent = (props) => {
  return (
    <div className='h-full w-full absolute p-6 flex flex-col justify-between'>
        <h1 className='h-10 w-10 bg-white flex gap-10 items-center justify-center rounded-full font-medium'>{props.id}</h1>
        <div className='flex flex-col gap-15'>
            ...
            <button className='flex justify-between bg-blue-500 rounded-full p-3'>
